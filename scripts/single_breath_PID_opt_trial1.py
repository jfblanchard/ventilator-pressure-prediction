...
This script is an analysis of the Ventillator prediction competition.  It:

    1. Reads in train and test files
    2. Allows selection of individual breaths (all 80 values long)
    3. Makes a dt and volume column
    4. Plots breath u_in and pressure
